...
local Packets={
	["RequestPlot"]=ReplicatedStorageReplicatedStorage.GameSystems.Packages.Networker["leifstout_networker@0.3.0"].networker._remotes.PlotService.RemoteEvent
}
...
Event:FireServer(
    "LikePlot",
    game:GetService("Players")["1976Thony"]
}
local Interfaces={
