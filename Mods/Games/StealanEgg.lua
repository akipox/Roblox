...
-- https://gitlab.com/upio/cobalt
                ...
                AssetScale = 0.87601706187126
            },
            d9239720da134fac817d4de7c34c3ada = {
                HasParasite = false,
                AssetColorSeed = 317943873,
                AssetColorIndex = 1,
                AssetEyeColor = "8ac75a",
                Mutations = {},
                AssetCategory = "Frog",
                GrowthSpeedMultiplier = 1,
                AssetScale = 0.91978806990984
            },
            ["1c75059796654f1997d296c3185294dc"] = {
                AssetScale = 0.97266725971256,
                AssetColorSeed = 1575530999,
                Mutations = {},
                AssetCategory = "Dog",
                AssetColorIndex = 5,
                GrowthSpeedMultiplier = 1,
                AssetEyeColor = "a85341"
            },
            b07374b05b6749b7ac9f9998ea04ac9c = {
                AssetEyeColor = "727034",
                AssetColorSeed = 1527449328,
                Placement = {
                    LocalCFrame = CFrame.new(-1.6550598144531, -0.50011444091797, -8.7782592773438, 0, 0, 1, 0, 1, -0, -1, 0, 0),
                    GrowthCreditSeconds = 0,
                    PlacedAt = 1788280547.5853
                },
                AssetScale = 0.98916027047647,
                Mutations = {},
                AssetColorIndex = 3,
                GrowthSpeedMultiplier = 1,
                AssetCategory = "Raccoon"
            },
            ["9039f23981cf4a8a895445399a629e58"] = {
                HasParasite = false,
                AssetColorSeed = 1775632169,
                AssetColorIndex = 1,
                AssetEyeColor = "334577",
                Mutations = {},
                AssetCategory = "Frog",
                GrowthSpeedMultiplier = 1,
                AssetScale = 0.92759957287447
            },
            cd7454728e784cf4a6c487c67632877f = {
                AssetEyeColor = "885389",
                AssetColorSeed = 1575639142,
                Placement = {
                    PlacedAt = 1788283071.1859,
                    LocalCFrame = CFrame.new(12.390747070312, -0.50011444091797, -6.5368194580078, 1, 0, 0, 0, 1, 0, 0, 0, 1)
                },
                AssetScale = 1.0444090354782,
                AssetColorIndex = 1,
                HasParasite = false,
                Mutations = {},
                GrowthSpeedMultiplier = 1,
                AssetCategory = "Turtle"
            },
            ["38215a97daed4112955245e27b53cb92"] = {
                AssetEyeColor = "d8c976",
                AssetColorSeed = 1881380021,
                Placement = {
                    PlacedAt = 1788283042.9704,
                    LocalCFrame = CFrame.new(-14.661071777344, -0.50011444091797, -18.312316894531, 1, 0, 0, 0, 1, 0, 0, 0, 1)
                },
                AssetScale = 3.9943019119686,
                AssetColorIndex = 0,
                HasParasite = false,
                Mutations = {},
                GrowthSpeedMultiplier = 1,
                AssetCategory = "Chillin Chilli"
            },
            ["592feec420d44d55abdc172d571e5c7c"] = {
                H
				local ok, result = pcall(function()
		...
		if Packets.Place and LastInventory then
			print("Auto Place:",v)
		end
	end
})
